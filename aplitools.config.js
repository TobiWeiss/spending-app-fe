module.exports = {
  ...
  apiKey: 'BsOhEcSV105n5qO110ACbBnqScxrGGQ55DoTP66Xvl5T6d4110',
  ...
  browser: [
    ...
    {width: 800, height: 600, name: 'chrome'}, {width: 1600, height: 1200, name: 'firefox'}, {
      width: 1024,
      height: 768,
      name: 'safari'
    },
    ...
    {deviceName: 'Pixel 2', screenOrientation: 'portrait'}, {deviceName: 'Nexus 10', screenOrientation: 'landscape'},]
}
